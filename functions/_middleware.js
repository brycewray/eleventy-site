...
export default async function onRequest(request) {
  ...
  if (ttl) {
    ...
    // newHeaders.set("Content-Security-Policy", `report-uri https://brycewray.report-uri.com/r/d/csp/reportOnly; default-src 'self' https://*.brycewray.com; connect-src 'self' https://*.brycewray.com https://*.cloudinary.com https://*.cloudflareinsights.com https://cloudflareinsights.com https://*.ytimg.com https://*.ggpht.com https://*.youtube-nocookie.com; base-uri 'self' https://*.brycewray.com; frame-src 'self' https://*.brycewray.com https://*.youtube-nocookie.com; frame-ancestors 'self' https://*.brycewray.com https://*.youtube-nocookie.com; form-action 'self'; style-src 'nonce-${nonce}' 'self' https://*.brycewray.com https://*.youtube-nocookie.com data:; img-src 'self' https://*.brycewray.com https://*.cloudinary.com https://*.ytimg.com https://*.ggpht.com https://*.youtube-nocookie.com https://*.gstatic.com https://*.twimg.com data:; font-src 'self' https://*.brycewray.com https://*.gstatic.com data:; script-src 'nonce-${nonce}' https: 'self' https://*.brycewray.com https://*.cloudinary.com https://*.cloudflareinsights.com https://cloudflareinsights.com https://*.ytimg.com https://*.ggpht.com https://*.youtube-nocookie.com https://*.twimg.com`)
