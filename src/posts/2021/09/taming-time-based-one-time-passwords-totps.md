...
{% imgc "MS_Authenticator_recovery_prompt_annotated_1125x2436.png", "Annotated screen capture from Microsoft Authenticator application setup process", 1125, 2436, "phn" %}
...
{% imgc "Aegis_screenshot_edited_1080x1920.png", "Edited screen capture of Aegis Authenticator application", 1080, 1920, "phn" %}
...
{% imgc "Raivo-OTP_screenshot_edited_1125x2436.png", "Edited screen capture of Raivo OTP application", 1125, 2436, "phn" %}
...
{% imgc "OTP_Auth_screenshot_edited_1125x2436.png", 1125, 2436, "Edited screen capture of OTP Auth application", "phn" %}
...
{% imgc "Tofu_Authenticator_screen_cap_edited_1125x2436.png", 1125, 2436, "Edited screen capture of Tofu Authenticator application", "phn" %}
