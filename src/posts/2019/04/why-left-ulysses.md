...
{% imgc "Ulysses_export_to_Markdown_750x528.jpg", "Screen capture of Quick Export feature of Ulysses app", 750, 528 %}

Ulysses's Quick Export feature: the only way you can derive a true, standalone, visible Markdown&nbsp;file from one of its native, proprietary-format&nbsp;files.{.imgcCaption}
...
{% imgc "iCloud_sync-save_icon_in_Ulysses_634x265.jpg", "[Screen capture from Ulysses showing iCloud icon, indicating ongoing sync", 634, 265 %}

When this little cloud icon (highlighted in the yellow circle) just sits and sits and sits in the Ulysses sheet synopsis and the timestamp doesn't change, even though you edited this file days ago on another device---Houston, we have an iCloud&nbsp;sync&nbsp;problem.{.imgcCaption}
...
{% imgc "iA_Writer_on_why-left-ulysses_post_cropped_1272x620.jpg", "Screen capture from iA Writer app", 1272, 620 %}

Ladies and gentlemen, the winner (for now): iA&nbsp;Writer.{.imgcCaption}
