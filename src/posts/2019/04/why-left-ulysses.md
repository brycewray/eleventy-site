...
{% imgc "Ulysses_export_to_Markdown_750x528.png", "Screen capture of Quick Export feature of Ulysses app", 750, 528 %}
...
{% imgc "iCloud_sync-save_icon_in_Ulysses_634x265.png", "Screen capture from Ulysses showing iCloud icon, indicating ongoing sync", 634, 265 %}
...
{% stweet "BryceWrayTX", "1114140807764893696" %}
...
{% imgc "iA_Writer_on_why-left-ulysses_post_cropped_2544x1241.png", "Screen capture from iA Writer app", 2544, 1241 %}
