...
{% imgc "tweet-1549447287625207809-from-2022-07-19-1233CDT_1190x1494.png", "Screen capture of tweet ID 1549447287625207809", 1190, 1494 %}

The next day, I got a response from [@gaetawoo](https://twitter.com/gaetawoo) --- not about my post, but about that social/OG image:

{% stweet "gaetawoo", "1549779097978642432" %}
...
{% imgc "2022-07-23-sample-title-with-gradient_1024x512.jpg", "Sample title graphic for this post, with text on a dark gradient and the site’s “BW” logo", 1024, 512 %}
