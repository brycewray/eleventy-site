...
{% imgc "Typography-scr-cap-2-2018-10-16_1344x200.png", "Thin and dim text that is hard to read", 1344, 200 %}

{% imgc "Typography-scr-cap-3-2018-10-16_1398x252.png", "More dim text that is hard to read", 1398, 252 %}

{% imgc "Typography-scr-cap-4-2018-10-16_1398x164.png", "Still more dim text that is hard to read", 1398, 164 %}
