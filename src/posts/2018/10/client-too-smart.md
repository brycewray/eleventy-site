...
imgs:
- Outlook_full_img_1800x2820.png
- Outlook_full_no_imgs_1800x2820.png
---
...
{% imgc "Outlook_full_img_1800x2820.png", "Fancy email from ad agency with styled text and artwork", 1800, 2820 %}

. . . this is what actually gets through the desktop version of Outlook:

{% imgc "Outlook_full_no_imgs_1800x2820.png", "Email with many blank spaces because email client blocks images", 1800, 2820 %}
...
This also has the side benefit of being somewhat of a qualifier --- or, if you will, a "self-selector." After all: if someone isn't even willing to click a link to go to a landing page, they clearly aren't sufficiently interested in what you're marketing that you should be wasting your company's limited resources chasing them. Right?
